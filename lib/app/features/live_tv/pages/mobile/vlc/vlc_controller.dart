...
import 'package:iptv/app/features/live_tv/pages/mobile/vlc/controls_overlay.dart';
...
class VlcPlayerWithControlsState extends State<VlcPlayerWithControls>
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    onTap: () async {
                      selectedSubId = index < subtitleTracks.keys.length
  ...
  Future<void> _getAudioTracks() async {
    ...
    if (audioTracks.isNotEmpty) {
      var idx = 0;
      final selectedAudioTrackId = await showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return ListTile(
                    ...
                    onTap: () {
                      idx = index < audioTracks.keys.length
      ...
      if (selectedAudioTrackId != null) {
        await _controller.setAudioTrack(idx);
      }
    }
  }
  ...
  Future<void> _getRendererDevices() async {
    ...
    if (castDevices.isNotEmpty) {
      final selectedCastDeviceName = await showDialog(
        context: context,
        builder: (BuildContext context) {
          return AlertDialog(
      ...
      await _controller.castToRenderer(selectedCastDeviceName.toString());
    } else {
